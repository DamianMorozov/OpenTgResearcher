...
public interface ITgEfUserRepository : ITgEfRepository<TgEfUserEntity, TgEfUserDto>, IDisposable
{
    ...
    public Task<List<TgEfUserDto>> GetUsersBySourceIdJoinAsync(long sourceId, long userId, Expression<Func<TgEfUserDto, bool>>? where, CancellationToken ct = default);
