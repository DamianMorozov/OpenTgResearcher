...
- Обновлена страница `Содержимое чата` в `OpenTgResearcherDesktop`
- Обновлена страница `Статистика чата` в `OpenTgResearcherDesktop`
- Обновлена анимация загрузки программы
- Обновлена кнопка копирования в `OpenTgResearcherDesktop`
- Обновлена страница `Логи` в `OpenTgResearcherDesktop`
- Обновлена страница `Детали пользователя` в `OpenTgResearcherDesktop`
- Обновлена страница `Чаты` в `OpenTgResearcherDesktop`
...
- Добавлено описание добавления лицензии в `OpenTgResearcherDesktop`
- Добавлен прогресс скачивания медиа файлов на странице `Содержимое чата` в `OpenTgResearcherDesktop`
- Добавлено скачивание обложек для медиа файлов
- Добавлен запрос комьюнити лицензии
