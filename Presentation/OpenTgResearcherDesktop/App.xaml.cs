    ...
    public App()
    {
        ...
        Host = Microsoft.Extensions.Hosting.Host.CreateDefaultBuilder()
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton<TgChatContentPage>();
                services.AddSingleton<TgChatContentViewModel>();
                services.AddSingleton<TgChatDownloadPage>();
                services.AddSingleton<TgChatDownloadViewModel>();
                services.AddSingleton<TgChatInfoPage>();
                services.AddSingleton<TgChatInfoViewModel>();
                services.AddSingleton<TgChatMyMessagesPage>();
                services.AddSingleton<TgChatMyMessagesViewModel>();
                services.AddSingleton<TgChatPage>();
                services.AddSingleton<TgChatParticipantsPage>();
                services.AddSingleton<TgChatParticipantsViewModel>();
                services.AddSingleton<TgChatSettingsPage>();
                services.AddSingleton<TgChatSettingsViewModel>();
                services.AddSingleton<TgChatsPage>();
                services.AddSingleton<TgChatStatisticsPage>();
                services.AddSingleton<TgChatStatisticsViewModel>();
                ...
                services.AddSingleton<TgProxyPage>();
